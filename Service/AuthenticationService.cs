...
using Entities.Exceptions.BadRequest.Users;
...
namespace Service.Users
{
    internal sealed class AuthenticationService : IAuthenticationService
    {
        ...
        {
            // Aquí generamos una clave con 32 bytes de longitud
        ...
        public async Task<IEnumerable<UserDto>> GetRegisteredUsers()
        {
            var users = await _userManager.Users.ToListAsync(); // Obtener todos los usuarios registrados
